...
const validatorSchema = schema.create({
  ...
  userId: schema.string.optional({}, [rules.uuid({ version: 4 })]),
  organizationId: schema.string({}, [rules.uuid({ version: 4 })]),
})

class GetOrganizationUsersWorkSummaryValidator {
...
export default new GetOrganizationUsersWorkSummaryValidator()
